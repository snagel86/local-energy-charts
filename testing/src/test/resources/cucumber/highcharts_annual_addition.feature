Feature: Highcharts Annual Addition
  ...
  and stored in a database. With the data thus quickly available,
  the installation additions of solar systems can then be calculated,
  and requested for visualization with Highcharts.
