package de.local.energycharts.infrastructure.solarcity.adapter;

import de.local.energycharts.infrastructure.solarcity.adapter.document.MongoSolarCity;
import de.local.energycharts.infrastructure.solarcity.adapter.document.mapper.MongoSolarCityMapper;
